...
def main(cfg: DictConfig) -> None:
    ...
    loaded_model = MaskablePPO(
        env=train_env,
        **model_config,
    )

    loaded_model.set_parameters(LOAD_BEST_MODEL_PATH, exact_match=True)

    loaded_model.learn(**continue_learn_config, reset_num_timesteps=True)
    ...
    # if cfg.heuristic_stability:
    #     train_env.env_method(
    #         'set_minimal_support', cfg.heuristic_stability
    #     )
    #     eval_env.env_method(
    #         'set_minimal_support', cfg.heuristic_stability
    #     )
